  ...
  <div className='h-full overflow-scroll'>
    {list?.map((v, i) => (
      <Link href={v.link} passHref key={i}>
        <div className='Anim AnimOpacity-80 mt-1 w-full cursor-pointer border-2 border-transparent border-l-quaternary-2 bg-white/20 p-2 dark:border-l-primary-0 dark:bg-black/20'>
